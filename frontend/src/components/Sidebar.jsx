...
// Modern minimal vector stroke SVG icons matching Lucide styling
const Icons = {
  dashboard: (
...
export default function Sidebar({ activeTab, setActiveTab, config, isOpen, onClose }) {
  const menuItems = [
    ...
    { id: 'queue', label: 'Random Queue', icon: Icons.queue },
    { id: 'automation', label: 'Campaign Automation', icon: Icons.automation },
    { id: 'comment-automation', label: 'Comment Auto-DM', icon: Icons.chat },
    { id: 'scheduled', label: 'Scheduled Jobs', icon: Icons.scheduled },
